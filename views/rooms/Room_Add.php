...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($roomController->addRoom($name, $description)) {
                        ...
                        <div class="col-8 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Add Room Information like Name and Description</p>
                                    <form class="forms-sample" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-primary mr-2">Create Room</button>
                                        <a href="Room_Dashboard.php" class="btn btn-dark">Cancel</a>
                                    </form>
                                    <?php if (isset($error))

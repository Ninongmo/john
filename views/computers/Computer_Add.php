...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($computerController->addComputer($serial_number, $specifications, $purchase_date, $conditions, $room_id, $user_id, $peripherals)) {
        $computerController->logActivity($user_id, 'add', 'Added a new computer with serial number ' . $serial_number);
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                ...
                                <a class="dropdown-item preview-item" href="../admin/dashboard.php">z
                ...
                <div class="content-wrapper">
                    <div class="content-wrapper d-flex justify-content-center align-items-center">
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Add Computer</h4>
                                    <p class="card-description">Add Computer and also peripherals</p>
                                    ...
                                    <form class="forms-sample" method="POST">
                                        ...
                                        <div id="peripherals">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="peripherals"
                                                    name="peripherals[0][type]" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="peripherals"
                                                    placeholder="Brand Name" name="peripherals[0][brand]" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="peripherals">Model</label>
                                                <input type="text" class="form-control" id="peripherals"
                                                    placeholder="Model Name" name="peripherals[0][model]" required>
                                            </div>
                                        </div>
                                        ...
                                        <br>
                                        <br>
                                        <button type="submit" class="btn btn-primary mr-2">Add Computer</button>
                                        <a href="Computer_Dashboard.php" class="btn btn-dark">Cancel</a>
                                    </form>
                                    <?php if (isset($error))

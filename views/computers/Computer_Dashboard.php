...
$computers = $computerController->getAllComputersWithPeripherals();
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        <h4 class="card-title mb-0">Computer Management</h4>
                                        <a href="Computer_Add.php" class="btn btn-success create-new-button">
                                            Add Computer
                                        </a>
                                    </div>
                                        ...
                                        <table class="table" id="computerTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if (!empty($computer['peripherals'])): ?>
                                                    <td>

                                                        <?php foreach ($computer['peripherals'] as $peripheral): ?>
                                                        <?php if ($peripheral['type'] == 'mouse'): ?>
                                                        <div class="badge badge-outline-info">Mouse</div>
                                                        <?php elseif ($peripheral['type'] == 'monitor'): ?>
                                                        <div class="badge badge-outline-light">Monitor</div>
                                                        <?php elseif ($peripheral['type'] == 'keyboard'): ?>
                                                        <div class="badge badge-outline-warning">Keyboard</div>
                                                        <?php endif; ?>
                                                        <?php endforeach; ?>

                                                    </td>
                                                    <?php else: ?>
                                                    <div class="badge badge-outline-warning">No Peripherals</div>
                                                    <?php endif; ?>
                                                    <td>
                                                        <a href="Computer_Edit.php?id=<?= $computer['id'] ?>"
                                                            class="btn btn-primary create-new-button">
                                                            Edit
                                                        </a>
                                                        <a href="delete.php?id=<?= $computer['id'] ?>"
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        searchInput.addEventListener("input", function() {
            ...
            for (let i = 1; i < rows.length; i++) {
                ...
                rows[i].style.display = found ? "NONE" : "none";
            }
        });
    });
    </script>

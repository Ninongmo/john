...
CREATE TABLE `computers` (
  ...
  `conditions` enum('working','under maintenance','not working') DEFAULT 'working',
...
CREATE TABLE `peripherals` (
  ...
  `type` enum('mouse','keyboard','monitor') NOT NULL,
...
--
ALTER TABLE `peripherals`
  ADD CONSTRAINT `peripherals_ibfk_1` FOREIGN KEY (`computer_id`) REFERENCES `computers` (`id`) ON DELETE CASCADE;
COMMIT;
